...
const PATHS = [
  {
    ...
    body: 'A focused 2-hour live session on the mechanics behind reformer springs and the equipment variables that change how a body is loaded. The fastest way in.',
    meta: '$99',
    ctaLabel: 'Learn more',
  ...
  },
  {
    ...
    body: 'A small-cohort deep dive: free-body diagrams, chair and tower physics, and physics-based progression planning. Group lectures, homework, and monthly 1:1 calls.',
    meta: 'By application',
    ctaLabel: 'Learn more',
  ...
  },
  {
    eyebrow: 'Private',
    title: '1:1 mentoring',
    body: 'Ongoing private mentoring tailored to the questions you have right now — your clients, your studio, your equipment. Limited slots, opens periodically.',
    meta: 'By inquiry',
    ctaLabel: 'Inquire',
    href: '#inquiry',
  },
  {
    ...
    body: 'Bring Pilates Physics to your studio or training program. Custom-built sessions from a half-day intro to a multi-day deep dive.',
    meta: 'By inquiry',
    ctaLabel: 'Inquire',
    href: '#inquiry',
  },
