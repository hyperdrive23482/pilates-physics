...
import FootworkVideo from './springs101/FootworkVideo'
import SpringCalcFAQ from './springs101/SpringCalcFAQ'
...
export default function SpringLoadCalculator() {
  ...
  return (
    <div className="spring-calc-root">
      ...
      <section className="spring-calc-tabs">
        <Tabs
          ariaLabel="Spring calculator reference"
          defaultId="video"
          tabs={[
            {
              id: 'video',
              label: 'See Your Spring Weights',
              render: () => <FootworkVideo />,
            },
            {
              id: 'primer',
              label: 'Spring Mechanics',
              render: () => <SpringBasics unit={unit} />,
            },
            {
              id: 'faq',
              label: 'FAQs',
              render: () => <SpringCalcFAQ />,
            },
          ]}
        />
      </section>
