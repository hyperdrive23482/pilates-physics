-- ============================================================
-- Pilates Physics: Blog draft seed — "Personalization in Pilates"
--
-- Post-Expo piece arguing that personalization is two problems:
-- adapting in the room (Pilates Physics 101) and holding the thread
-- across sessions (Remo). Native post, so canonical_url stays null.
--
...
--   1. The "What it is not" paragraph in the Remo section states a scope
--      limit that was drafted as a placeholder. Replace it with the real
--      constraint before this goes live.
--   2. Add a featured image (Expo floor, or teaching in a group setting)
--      plus alt text. Recommended ~1600x900, under 500 KB.
--   3. Set status to Published. Leave "Published at" blank to use now.
--
...
values (
  'personalization-in-pilates',
  'Personalization in Pilates: everyone agreed, nobody said how',
  $excerpt$Leaders at the Pilates Journal Expo agreed that personalization is what makes a studio endure. Nobody said how. It turns out to be two problems, and only one of them is teachable.$excerpt$,
  $body$I am home from Miami, still a little wrung out, and very glad I went. Meeting so many of you IRL after months of talking through a screen was the best part of the [Pilates Journal Expo](https://www.pilatesjournalexpo.com/). The second best part was what I heard from the stage.
...
It belongs in the room too. I would like to help bring it there next year.$body$,
  'draft'
)
